...
![JSON object](images/91210783.jpg)
...
![JSON array](images/13650476.jpg)
...
![Json value](images/14122608.jpg)
...
![JSON string](images/85287197.jpg)

* 数值（number）也与C或者Java的数值非常相似。除去未曾使用的八进制与十六进制格式。除去一些编码细节。

![JSON number](images/66268162.jpg)
